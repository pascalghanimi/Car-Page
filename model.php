...
<body>
    <div class="container">
        ...
        <img id="image" src="images/car7.jpg" alt="">
        <div class="info-container">
            <h1 id="heading">Model Alpha</h1>
            <p id="info">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nulla rerum accusantium excepturi quis neque dignissimos maiores enim nesciunt voluptas deleniti, architecto dolor, veritatis maxime reiciendis, ipsum tenetur. Voluptatem, vel. Obcaecati architecto aliquid, dolores minus dolore totam reiciendis molestias vitae aliquam.</p>
        </div>
